...
![Gemini](https://img.shields.io/badge/LLM-Gemini%201.5-green)
...
- 🤖 **Gemini LLM** — Google's Gemini 1.5 Flash for fast, grounded responses
...
- 🎨 **Premium Dark Theme** — Polished glassmorphism UI with gradient accents
...
│   └── ui/
│       ├── sidebar.py              # Sidebar: branding, status, controls
│       └── chat.py                 # Chat history & input handler
│
├── data/
│   └── company_knowledge.pdf       # Your company knowledge base PDF
│
...
### 4. Generate the sample PDF (optional)

A sample company knowledge base PDF can be generated for testing:
...
COMPANY_NAME=IntellectBot
PDF_PATH=./data/company_knowledge.pdf
```
...
| `COMPANY_NAME`    | `MyCompany`                       | Displayed in UI & prompts      |
| `PDF_PATH`        | `./data/company_knowledge.pdf`    | Path to your knowledge base    |
